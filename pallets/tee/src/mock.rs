...
frame_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Tee: pallet_tee::{Pallet, Call, Storage, Event<T>},
	}
);
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	.unwrap();
	let tee_config = crate::GenesisConfig { allow_sgx_debug_mode: true };
	GenesisBuild::<Test>::assimilate_storage(&tee_config, &mut t).unwrap();
...
pub fn new_test_production_ext() -> sp_io::TestExternalities {
	...
	let tee_config = crate::GenesisConfig { allow_sgx_debug_mode: false };
	GenesisBuild::<Test>::assimilate_storage(&tee_config, &mut t).unwrap();
